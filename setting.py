...
class Storyline:
  ...
  def play_introduction(cls):
    ...
    old_man.speak("Don't worry. To help you track your progress, I am giving you an Artipedia. In case you ever need my help, type 'hlp' in the main menu. Start your journey by exploring the wilderness. ")
