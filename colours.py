class Colours:
    ...
    heading = (
        lambda string, colour=heading_colour: f"{colour + Colours.underline}{string}{Colours.reset}"
    )

    alert = (
        lambda string: f"{Colours.fg.red + Colours.bold + Colours.underline}{string}{Colours.reset}"
    )
